...
# alerts. Read from environment variables.
...
class Twitter:
    ...
    def start_streaming(self, callback):
        ...
        twitter_stream.filter(follow=[T_USER_ID])
    ...
    def get_all_tweets(self):
        ...
        # the @ account to filter down to the relevant ones.
...
class TwitterListener(StreamListener):
    ...
    def handle_data(self, logs, data):
        ...
        # We're only interested in tweets from  himself, so skip the
        # rest.
        if user_id_str != T_USER_ID:
